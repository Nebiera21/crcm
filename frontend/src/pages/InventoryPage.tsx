  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      const payload: RouterCreate = {
        ...
        snmp_v3_auth_password: showAuth && form.snmp_v3_auth_password ? form.snmp_v3_auth_password : (isEdit ? undefined : null),
        snmp_v3_priv_protocol: showPriv ? ((form.snmp_v3_priv_protocol || null) as import('@/types/router').SnmpPrivProtocol | null) : null,
        snmp_v3_priv_password: showPriv && form.snmp_v3_priv_password ? form.snmp_v3_priv_password : (isEdit ? undefined : null),
